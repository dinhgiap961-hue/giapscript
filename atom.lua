-- DRAGON BLOX V2 - FIX KHÔNG HIỆN GUI - DÙNG PLAYERGUI
...
-- KNIT - ĐỢI LOAD
local Knit, SkillController
task.spawn(function()
    repeat task.wait() until game:GetService("ReplicatedStorage"):FindFirstChild("Packages")
    Knit = require(game:GetService("ReplicatedStorage").Packages.Knit)
    repeat task.wait() until Knit.Controllers
    SkillController = Knit.Controllers.SkillController or Knit.Controllers.SkillManager or Knit.Controllers.CombatController
    print("KNIT LOADED:", SkillController and "OK" or "FAIL")
end)
...
Title.Text = "DBV2 FIX GUI | ĐANG TẢI..."
...
HeightSlider.Text = "Đổi chiều cao 60/100"
...
HeightSlider.ZIndex = 1000
Instance.new("UICorner", HeightSlider)

HeightSlider.MouseButton1Click:Connect(function()
    getgenv().DBV2.FlyHeight = getgenv().DBV2.FlyHeight == 60 and 100 or 60
    HeightLabel.Text = "Chiều cao: "..getgenv().DBV2.FlyHeight
end)
...
print("=== DBV2 ĐÃ LOAD - NHÌN GÓC TRÁI TRÊN CÓ NÚT DB ===")
